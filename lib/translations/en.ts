export const en = {
  ...
  failedValidatingSubmission: "Failed validating your submission!",
  ...
  // Tools
  toolWeather: "Weather",
  toolWeatherDesc: "Get current weather information",
  toolCreateDocument: "Create Document",
  toolCreateDocumentDesc: "Create a new document",
  toolUpdateDocument: "Update Document",
  toolUpdateDocumentDesc: "Update existing document",
